...
then
  ...
  export TF_VAR_data_migrate="$PROD_DATA_MIGRATE"
  ...
  export TF_VAR_skylight_access_token="$SKYLIGHT_ACCESS_TOKEN"
  export TF_VAR_skylight_env="$SKYLIGHT_ENV"
  export TF_VAR_skylight_enable_sidekiq="$SKYLIGHT_ENABLE_SIDEKIQ"
...
then
  ...
  export TF_VAR_data_migrate="$STAGING_DATA_MIGRATE"
