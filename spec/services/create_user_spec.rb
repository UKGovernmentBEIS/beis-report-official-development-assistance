...
RSpec.describe CreateUser do
  ...
  describe "#call" do
    it "returns a successful result" do
      result = CreateUser.new(user: user, organisation: build_stubbed(:delivery_partner_organisation)).call
    ...
    it "sends a welcome email to the user" do
      expect {
        CreateUser.new(user: user, organisation: build_stubbed(:delivery_partner_organisation)).call
