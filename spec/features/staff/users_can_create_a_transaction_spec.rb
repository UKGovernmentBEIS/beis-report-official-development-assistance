RSpec.feature "Users can create a transaction" do
  ...
  context "when the user is a fund_manager" do
    ...
    context "when the transaction is created on a fund" do
    ...
    context "when the transaction is created on a programme" do
      scenario "successfully creates a transaction on a programme" do
        fund = create(:fund, organisation: organisation)
  ...
  context "when the user is a delivery_partner" do
    ...
    scenario "cannot create a transaction that belongs to a programme" do
      fund = create(:fund, organisation: organisation)
      programme = create(:programme, fund: fund)

      visit new_programme_transaction_path(programme)
